...
import * as _$_langchain_core_outputs0 from "@langchain/core/outputs";
 ...
 */
type AnthropicMessagesModelId = Anthropic.Model | (string & NonNullable<unknown>);
/**
 ...
 */
type ChatAnthropicInput = AnthropicInput & BaseChatModelParams;
/**
...
declare class ChatAnthropicMessages<CallOptions extends ChatAnthropicCallOptions = ChatAnthropicCallOptions> extends BaseChatModel<CallOptions, AIMessageChunk> implements AnthropicInput {
   ...
   */
  formatStructuredToolToAnthropic(tools: ChatAnthropicCallOptions["tools"], fields?: {
    strict?: boolean;
  ...
  _identifyingParams(): {
    ...
    tools?: Array<Anthropic.ToolUnion>;
    top_k?: number;
    top_p?: number;
  ...
  _generateNonStreaming(messages: BaseMessage[], params: Omit<Anthropic.Messages.MessageCreateParamsNonStreaming | Anthropic.Messages.MessageCreateParamsStreaming, "messages"> & Kwargs, requestOptions: AnthropicRequestOptions): Promise<{
    generations: _$_langchain_core_outputs0.ChatGeneration[];
    llmOutput: {
      id: string;
      container: Anthropic.Container | null;
      model: Anthropic.Model;
...
//#endregion
export { AnthropicCacheControl, AnthropicInput, AnthropicMessagesModelId, ChatAnthropic, ChatAnthropicCallOptions, ChatAnthropicInput, ChatAnthropicMessages };
