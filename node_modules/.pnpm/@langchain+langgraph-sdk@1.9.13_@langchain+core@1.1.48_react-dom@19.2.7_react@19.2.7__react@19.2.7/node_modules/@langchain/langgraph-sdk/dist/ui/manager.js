		...
		try {
			...
			for await (const { event, data } of run) {
				...
				if (this.matchEventType("messages", event, data)) {
					...
					const eventCheckpointNs = namespace && isSubagentNamespace(namespace) ? namespace : void 0;
					...
					const toolCallId = isFromSubagent ? extractToolCallIdFromNamespace(checkpointNs) : void 0;
