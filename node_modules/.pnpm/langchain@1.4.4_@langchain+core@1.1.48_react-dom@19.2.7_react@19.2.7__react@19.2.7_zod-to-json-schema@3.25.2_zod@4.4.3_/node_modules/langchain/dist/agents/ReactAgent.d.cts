...
import { AnyAgentMiddleware, AnyAnnotationRoot, InferContextInput, InferMiddlewareContextInputs, InferMiddlewareInputStates, InferMiddlewareStates, InferSchemaValue, ToAnnotationRoot } from "./middleware/types.cjs";
import { AgentTypeConfig, BuiltInState, CreateAgentParams, ToolsToMessageToolSet, UserInput } from "./types.cjs";
import { AgentRunStream, InferStreamExtensions } from "./stream.cjs";
...
import { Command, CompiledStateGraph, GetStateOptions, LangGraphRunnableConfig, StateGraph, StreamMode, StreamOutputMap, StreamTransformer } from "@langchain/langgraph";
 ...
 * ```
 */
declare class ReactAgent<Types extends AgentTypeConfig = AgentTypeConfig<Record<string, any>, undefined, AnyAnnotationRoot, readonly AnyAgentMiddleware[], readonly (ClientTool | ServerTool)[], ReadonlyArray<() => StreamTransformer<any>>>> {
  #private;
   ...
   * ```
   */
  streamEvents(state: InvokeStateParameter<Types>, config: InvokeConfiguration<InferContextInput<Types["Context"] extends AnyAnnotationRoot | InteropZodObject ? Types["Context"] : AnyAnnotationRoot> & InferMiddlewareContextInputs<Types["Middleware"]>> & {
    version: "v3";
  ...
  streamEvents(state: InvokeStateParameter<Types>, config: (StreamConfiguration<InferContextInput<Types["Context"] extends AnyAnnotationRoot | InteropZodObject ? Types["Context"] : AnyAnnotationRoot> & InferMiddlewareContextInputs<Types["Middleware"]>, StreamMode | StreamMode[] | undefined, boolean, "text/event-stream" | undefined> & {
    version?: "v1" | "v2";
  }) | undefined, streamOptions: Parameters<Runnable["streamEvents"]>[2]): IterableReadableStream<StreamEvent>;
  /**
   ...
   * @internal
   */
  get builder(): StateGraph<unknown, any, any, any, any, any, any, unknown, unknown, unknown>;
}
//#endregion
export { ReactAgent };
