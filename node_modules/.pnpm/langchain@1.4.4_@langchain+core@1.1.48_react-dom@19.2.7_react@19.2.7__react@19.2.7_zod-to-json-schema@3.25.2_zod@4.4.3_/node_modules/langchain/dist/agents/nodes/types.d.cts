...
import { ResponseFormatInput } from "../responses.cjs";
 ...
 */
interface ModelRequest<TState extends Record<string, unknown> = Record<string, unknown>, TContext = unknown, TResponseFormat extends ResponseFormatInput = ResponseFormatInput> {
  /**
